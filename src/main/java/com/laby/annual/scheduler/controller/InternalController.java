package com.laby.annual.scheduler.controller.internal;

import com.laby.annual.scheduler.batch_processing.BatchImportService;
...
@RestController
@RequestMapping("/api/scheduler/internal/setup")
